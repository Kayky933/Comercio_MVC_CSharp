...
{
    public class FornecedorErrorMessages
    {
        ...
        public static string CNPJNulo = "O campo CNPJ não pode ter nulo!";
        public static string CNPJTamanho = "O campo CNPJ tem um tamanho máximo e mínimo de 18 caracteres!";
